...
Diese Datei listet die wichtigsten konfigurierbaren Eigenschaften und Parameter des Projekts auf. Jeder Eintrag verweist auf die relevante Quelldatei zur direkten Anpassung.

```config
# Simulation
# dt: Zeitschrittweite
# n: Anzahl der Disk-Partikel
# theta: Barnes-Hut-Winkelparameter
# epsilon: Gravitations-Softening
# accretion_spawn_rate: Wahrscheinlichkeit pro Schritt für einen Spawn
# inner_radius: Radius der zentralen Masse
# outer_radius: Außenradius der Scheibe
# outer_ring_spawn_zone_inner_radius: innerer Radius der äußeren Ring-Spawnzone
# outer_ring_spawn_zone_outer_radius: äußerer Radius der äußeren Ring-Spawnzone
# central_mass: zentrale Masse
# particle_mass_range: Partikel-Massenspanne als min,max
# inflow_strength: Stärke der äußeren Einströmung
# restore_strength: Stärke der vertikalen Rückführung
# galaxy_separation_factor: Faktor für den initialen Abstand zwischen den beiden Galaxien (Multipliziert mit outer_radius)
...
inner_radius: 25.0
outer_radius: 118.03
outer_ring_spawn_zone_inner_radius: 91.3
outer_ring_spawn_zone_outer_radius: 118.03
